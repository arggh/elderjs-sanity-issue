...
<div class="about">
  ...
  <p>
    ...
    site so it can be deployed with a static site host such as Netlify, Cloudflare Workers, Vercel, or S3.
  </p>
</div>
...
<div class="hydrate">
  <div class="left">
    ...
    <p>
      The <a href="https://svelte.dev/examples#clock">clock</a> on the this page is an example of a component that has been
